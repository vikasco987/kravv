    ...
    return (
      <View style={{ flexDirection: "row", alignItems: "center" }}>
        <Ionicons
          name={name}
          size={size}
          color={hasAccess ? color : COLORS.lock}
        />
        {!hasAccess && (
  ...
  return (
    <View>
      <DrawerItem
        label={() => (
          <View style={styles.labelContainer}>
            <Text
              style={[
                styles.labelText,
                !canAccessSync("Dashboard") && styles.lockedText,
              ]}
            >
              {t("dashboard")}
            </Text>
            {!canAccessSync("Dashboard") && (
              <Ionicons
        ...
        icon={({ color, size }) =>
          renderIcon("home-outline", color, size, "Dashboard")
        }
        onPress={() =>
          checkAndNavigate("Dashboard", "(tabs)", { screen: "Dashboard" })
        }
      />
      ...
      <DrawerItem
        label={() => (
          <View style={styles.labelContainer}>
            <Text
              style={[
                styles.labelText,
                !canAccessSync("Menu") && styles.lockedText,
              ]}
            >
              {t("home_menu")}
            </Text>
        ...
        icon={({ color, size }) =>
          renderIcon("cart-outline", color, size, "Menu")
        }
      ...
      <DrawerItem
        label={() => (
          <View style={styles.labelContainer}>
            <Text
              style={[
                styles.labelText,
                !canAccessSync("Order") && styles.lockedText,
              ]}
            >
              {t("orders")}
            </Text>
        ...
        icon={({ color, size }) =>
          renderIcon("list-outline", color, size, "Order")
        }
      ...
      <DrawerItem
        label="KOT"
        icon={({ color, size }) => (
          <Ionicons name="receipt-outline" size={size} color="#6366F1" />
        )}
        onPress={() => {
      ...
      <DrawerItem
        ...
        icon={({ color, size }) =>
          renderIcon("qr-code-outline", color, size, "Menu")
        }
      ...
      <DrawerItem
        ...
        icon={({ color, size }) =>
          renderIcon("create-outline", color, size, "Menu")
        }
      ...
      <DrawerItem
        label={() => (
          <View style={styles.labelContainer}>
            <Text
              style={[
                styles.labelText,
                !canAccessSync("Reports") && styles.lockedText,
              ]}
            >
              Item Sales Report
            </Text>
            {!canAccessSync("Reports") && (
              <Ionicons
                name="lock-closed-outline"
                size={rf(14)}
                color={COLORS.lock}
        ...
        icon={({ color, size }) =>
          renderIcon("cube-outline", color, size, "Reports")
        }
      ...
      <DrawerItem
        ...
        icon={({ color, size }) =>
          renderIcon("receipt-outline", color, size, "Dashboard")
        }
      ...
      <DrawerItem
        label={() => (
          <View style={styles.labelContainer}>
            <Text
              style={[
                styles.labelText,
                !canAccessSync("Inventory") && styles.lockedText,
              ]}
            >
              Inventory
            </Text>
            {!canAccessSync("Inventory") && (
              <Ionicons
                name="lock-closed-outline"
                size={rf(14)}
                color={COLORS.lock}
        ...
        icon={({ color, size }) =>
          renderIcon("archive-outline", color, size, "Inventory")
        }
      ...
      <DrawerItem
        label={() => (
          <View style={styles.labelContainer}>
            <Text
              style={[
                styles.labelText,
                !canAccessSync("Settings") && styles.lockedText,
              ]}
            >
              {t("settings")}
            </Text>
            {!canAccessSync("Settings") && (
              <Ionicons
                name="lock-closed-outline"
                size={rf(14)}
                color={COLORS.lock}
        ...
        icon={({ color, size }) =>
          renderIcon("settings-outline", color, size, "Settings")
        }
        ...
        label={() => (
          <View style={styles.labelContainer}>
            <Text
              style={[
                styles.labelText,
                !canAccessSync("AI Intelligence Tools") && styles.lockedText,
              ]}
            >
              Profit Engine
            </Text>
      ...
      <DrawerItem
        ...
        icon={({ color, size }) =>
          renderIcon("mic-outline", "#6366F1", size, "AI Intelligence Tools")
        }
      ...
      <DrawerItem
        ...
        icon={({ color, size }) =>
          renderIcon("search-outline", "#f59e0b", size, "AI Intelligence Tools")
        }
