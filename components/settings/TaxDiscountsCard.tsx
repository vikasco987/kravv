        ...
        <View style={[styles.card, { marginTop: vs(12) }]}>
            ...
            >
                <View style={[styles.buttonIconBackground, { backgroundColor: COLORS.accent + "15" }]}>
                    <Ionicons name={"pricetag-outline" as any} size={rf(22)} color={COLORS.accent} />
                </View>
                <View style={{ flex: 1 }}>
                    <Text style={[styles.infoTitle, { marginBottom: 0 }]}>GST / VAT & discounts</Text>
                    <Text style={styles.infoText} numberOfLines={1}>Set your default tax rate and adjustments.</Text>
                </View>
