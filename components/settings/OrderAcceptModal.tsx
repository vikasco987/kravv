...
interface OrderAcceptModalProps {
    ...
    setOrderAutoAccept: (val: boolean) => void;
                    ...
                    <View style={styles.bottomSheetHeader}>
                        <View style={{ flexDirection: 'row', alignItems: 'center', gap: s(12) }}>
                            <View style={[styles.buttonIconBackground, { backgroundColor: COLORS.primary + "15", marginRight: 0 }]}>
                                <Ionicons name="checkmark-circle-outline" size={rf(24)} color={COLORS.primary} />
                            </View>
                            <View>
                                <Text style={styles.bottomSheetTitle}>Order Accept</Text>
                                <Text style={styles.settingSubLabel}>Manage how you receive and accept orders</Text>
                            </View>
                        </View>
                    </View>
                    ...
                    <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{ paddingBottom: vs(40) }}>
                        ...
                        <View style={[styles.featureCard, orderAutoAccept && styles.featureCardActive]}>
                            <View style={styles.featureIconContainer}>
                                <Ionicons name="flash-outline" size={rf(22)} color={orderAutoAccept ? COLORS.primary : COLORS.textLight} />
                            </View>
                            <View style={{ flex: 1 }}>
                                <Text style={styles.settingLabel}>Order Auto Accept</Text>
                                <Text style={styles.settingSubLabel}>When ON, all incoming orders will be accepted automatically</Text>
                            </View>
                            <Switch
                                value={orderAutoAccept}
                                onValueChange={(val) => {
                                    setOrderAutoAccept(val);
                                    onSave("order_auto_accept", val, "Order Auto Accept");
                                }}
                                trackColor={{ false: "#E5E7EB", true: COLORS.primary + "80" }}
                                thumbColor={orderAutoAccept ? COLORS.primary : "#F4F3F4"}
                            />
                        </View>
                        ...
                        <View style={styles.infoBox}>
                            ...
                            <Text style={styles.infoText}>
                                Turning on Auto Accept helps in processing orders faster without manual intervention.
                            </Text>
                        </View>
