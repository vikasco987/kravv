...
export const AddItemCategory = ({
  ...
  const handleSave = (isSaveAndNew: boolean) => {
    ...
    if (!trimmedName) {
      setModalMsg({
        title: t("name_missing") || "Name Missing!",
        detail: t("enter_category_name") || "Please enter category name.",
      });
    ...
    if (isSaveAndNew) {
      setCategoryName("");
      setModalMsg({
        title: t("category_saved") || "Category Saved!",
        detail: t("added_success") || "New category has been added.",
      });
    ...
    (async () => {
      try {
        ...
        if (finalToken) {
          const realCategory = await menuService.createCategory(
            finalToken,
            trimmedName,
            bId,
          );
        ...
        Alert.alert(
          "Sync Error",
          "The category was added locally but couldn't sync with the server (Timeout). Please check your internet or refresh the menu.",
        );
      }
    })();
  };
    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>
          {t("add_category") || "Add Item Category"}
        </Text>
      </View>
      ...
      <View style={styles.content}>
        ...
        <View style={styles.listSection}>
          <Text style={styles.listTitle}>
            {t("all_categories_label") || "ALL CATEGORIES"}
          </Text>
          <FlatList
      ...
      <View style={styles.footer}>
        ...
        >
          {isSavingNew ? (
            ...
            <Text style={styles.saveNewBtnText}>
              {t("save_and_new") || "Save & New"}
            </Text>
          )}
        </TouchableOpacity>
        <TouchableOpacity
          style={[
            ...
            {
              backgroundColor: isSavingCategory
                ? COLORS.SUCCESS
                : COLORS.PRIMARY,
            },
          ]}
